...
export const fillSalesTax0024Data = ({ deal, finance }: DealFormParams) => {
	...
	return {
		...
		"State of Sale": STATE,
		"Sales Tax Remitted with DR 0100": formatCurrency(finance?.stateTaxDollar),
		// "Use Tax Remitted with DR 0024": "",
		// "RTD/SCFD Name.0": "",
		"Tax Rate.0": deal.taxRtd || "",
		"Tax Rate.1": deal.taxCity || "",
		// "Tax Rate.2": deal.taxRtd || "",
		"Tax Rate.3": deal.taxCounty || "",
		"Sales Tax Remitted with DR 0100 1.0.0": formatCurrency(
			finance?.rtdTaxDollar,
		),
		"Sales Tax Remitted with DR 0100 1.0.1": formatCurrency(
			finance?.cityTaxDollar,
		),
		"Sales Tax Remitted with DR 0100 1.0.2": "-",
		"Sales Tax Remitted with DR 0100 1.0.3": formatCurrency(
